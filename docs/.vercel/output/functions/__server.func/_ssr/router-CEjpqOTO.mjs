...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CEjpqOTO.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-md border border-border bg-elevated px-3 py-1.5 text-xs text-fg shadow-panel", "origin-[--radix-tooltip-content-transform-origin]", "data-[state=delayed-open]:animate-in data-[state=delayed-open]:fade-in-0 data-[state=delayed-open]:zoom-in-95", "data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-NjTzTZgs.css";
var APP_NAME = "LLMScribe";
var DESCRIPTION = "Turn any project folder into one clean text file that AI tools can read. Open-source Python CLI, GUI, and CUI — published on PyPI.";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{ title: `${APP_NAME} — one file, the whole project` },
			{
				name: "description",
				content: DESCRIPTION
			},
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TooltipProvider, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
						...
						toastOptions: { className: "!bg-elevated !text-fg !border-border !font-sans !shadow-panel" }
					})]
				}) }),
...
var $$splitComponentImporter = () => import("./routes-DyhfDUwL.mjs");
